...
class SimpliVity:
    ...
    def VMpolicyImpactReport(self, vm_id, policy_id):
        body = '{"virtual_machine_id":"'+ vm_id +'",\
                 "policy_id":"'+ policy_id +'"}'
        return self.doPost(self.url+'virtual_machines/policy_impact_report/apply_policy')
    ...
    def CopyBackup(self, bckid, destination, storeName):
        ...
        return self.doPost(self.url+'backups/'+bckid+'/copy')
    ...
    def RegisterExternalStore(self, paramters):
        """
